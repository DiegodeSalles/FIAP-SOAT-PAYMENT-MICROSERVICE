...
@pytest.mark.asyncio
async def test_create_payment(mock_mongo_resources):
    mock_client, mock_collection = mock_mongo_resources
...
@pytest.mark.asyncio
async def test_get_by_id_found(mock_mongo_resources):
    mock_client, mock_collection = mock_mongo_resources
...
@pytest.mark.asyncio
async def test_get_by_id_not_found(mock_mongo_resources):
    mock_client, mock_collection = mock_mongo_resources
...
@pytest.mark.asyncio
async def test_get_by_external_id_found(mock_mongo_resources):
    mock_client, mock_collection = mock_mongo_resources
    mock_collection.find_one.return_value = {
        "_id": "1", "order_id": "o1", "customer_id": "c1", "amount": 10.0, "status": "pending",
...
@pytest.mark.asyncio
async def test_get_all(mock_mongo_resources):
    mock_client, mock_collection = mock_mongo_resources
...
@pytest.mark.asyncio
async def test_update_status(mock_mongo_resources):
    mock_client, mock_collection = mock_mongo_resources
